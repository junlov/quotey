...
- `support_email` - Optional support contact email used in footer contact copy
- `sender_name` - Optional sender/support contact name used in footer contact copy
- `terms_footer` - Optional legal/terms footer line rendered near terms and footer sections
...
Set `white_label: true` to remove "Generated by Quotey" footer across quote templates.

Suggested white-label payload shape:

```json
{
  "branding": {
    "company_name": "Partner CPQ",
